...
if __name__ == '__main__':
    ...
    for e in range(EPOCH):
        ...
        for i in range(0, BUFFER_MAX):
            ...
            MyValidStateSampler = MyValidStateSampler(si, gmm_dist)
            VALUE_ESTIMATE = MyValidStateSampler.get_count_max()
            experience = ([OC, SV, GV, W, VALUE_ESTIMATE])
            replay_buffer.append(experience)
            print('Current Batch', e+1,  'Waiting for buffer size ... {}/{}'.format(len(replay_buffer), BUFFER_MAX))
